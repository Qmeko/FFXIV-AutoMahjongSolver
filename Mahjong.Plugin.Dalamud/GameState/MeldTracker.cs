...
public sealed class MeldTracker
{
    ...
    /// <summary>
    /// Records a self-declared kan and drops the open-call inference baseline. Without the
    /// rebaseline, the preceding opponent discard can be mistaken for the source of the
    /// closed-hand shrink and the same kan is inferred again as a MinKan.
    /// </summary>
    public void Record(Meld meld)
    {
        melds.Add(meld);
